...
<div class="bio-container">
  <div class="bio-text">
    ...
    <p>I study institutions, elections, and party behavior, with a focus on climate change. Most of my current research is on the United States but I also study Europe, and in particular, how electoral system design affects how parties address 'new' issues in Europe. In a more applied body of work, I conduct research to establish policy evidence relevant to the energy transition. I also use experimental methods to study voter engagement and strategic campaign messaging.</p>
...
<!-- ========================= -->
<section id="research" class="bio-container" style="margin-top: 2rem;">
